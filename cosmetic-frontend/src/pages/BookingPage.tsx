              ...
              <div className="flex flex-col gap-5 rounded-3xl bg-white px-[14px] py-5">
                <div className="flex items-center gap-[10px]">
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="font-semibold text-[#030504]">
                      Informations
                    </h3>
                ...
                <label className="flex flex-col gap-[6px]">
                  ...
                  {formError.find((error) => error.path.includes("phone")) && (
                    <p className="text-sm leading-[21px] text-[#E70011]">
                ...
                <label className="flex flex-col gap-[6px]">
                  ...
                  {formError.find((error) => error.path.includes("email")) && (
                    <p className="text-sm leading-[21px] text-[#E70011]">
            ...
            <section id="ShippingTo">
              <div className="flex flex-col gap-5 rounded-3xl bg-white px-[14px] py-5">
                ...
                <label className="flex flex-col gap-[6px]">
                  ...
                  {formError.find((error) => error.path.includes("city")) && (
                    <p className="text-sm leading-[21px] text-[#E70011]">
                ...
                <label className="flex flex-col gap-[6px]">
                  ...
                  {formError.find((error) => error.path.includes("address")) && (
                    <p className="text-sm leading-[21px] text-[#E70011]">
                ...
                <label className="flex flex-col gap-[6px]">
                  ...
                  {formError.find((error) => error.path.includes("post_code")) && (
                    <p className="text-sm leading-[21px] text-[#E70011]">
