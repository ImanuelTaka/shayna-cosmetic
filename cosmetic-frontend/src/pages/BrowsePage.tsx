    ...
    useEffect(() =>{
      ...
      const fetchPopularCosmeticsData = async() =>{
        try {
          ...
          setError("Failed to load popular cosmetics");
        }finally{
      ...
      const fetchAllCosmeticsData = async()=>{
        try {
          ...
          setError("Failed to load all cosmetics")
        }finally{
          ...
          >
            ...
            >
              {popularCosmetics.length >0?(
                ...
                <p>belum memiliki data cosmetic</p>
              )}
            </Swiper>
          </div>
        </div>
      ...
      <section id="FreshThisSummer">
        <div className="flex flex-col gap-4 px-5">
          ...
          {allCosmetics.length > 0?(
            ...
            <p>Tidak memiliki data cosmetic</p>
          )}
        </div>
      </section>
